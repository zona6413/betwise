...
const STATIC_KNOWN = {
  ...
  '2384': { position: 17, wins: 14, draws: 9,  losses: 13, form: 'DWLWL', gpg: 1.42, cgpg: 1.31, homeGpg: 1.70, homeCgpg: 1.05, awayGpg: 1.14, awayCgpg: 1.57 }, // États-Unis
  ...
  '1118': { position: 9,  wins: 20, draws: 6,  losses: 10, form: 'WWWDL', gpg: 1.69, cgpg: 0.97, homeGpg: 2.00, homeCgpg: 0.73, awayGpg: 1.38, awayCgpg: 1.21 }, // Pays-Bas
  ...
  '15':   { position: 13, wins: 18, draws: 7,  losses: 11, form: 'WWDWL', gpg: 1.55, cgpg: 0.95, homeGpg: 1.75, homeCgpg: 0.75, awayGpg: 1.35, awayCgpg: 1.10 }, // Suisse
  '1569': { position: 28, wins: 8,  draws: 8,  losses: 18, form: 'LDWLL', gpg: 0.95, cgpg: 1.45, homeGpg: 1.10, homeCgpg: 1.25, awayGpg: 0.75, awayCgpg: 1.65 }, // Qatar (FIFA ~35e, plus faible que la Suisse même à domicile)
  '3':    { position: 12, wins: 18, draws: 6,  losses: 12, form: 'WWLDW', gpg: 1.75, cgpg: 1.14, homeGpg: 2.05, homeCgpg: 0.88, awayGpg: 1.45, awayCgpg: 1.40 }, // Croatie
  '13':   { position: 10, wins: 19, draws: 7,  losses: 10, form: 'WDWWL', gpg: 1.83, cgpg: 1.00, homeGpg: 2.15, homeCgpg: 0.75, awayGpg: 1.51, awayCgpg: 1.25 }, // Sénégal (AFRIQUE)
  '12':   { position: 15, wins: 15, draws: 9,  losses: 12, form: 'LDWDW', gpg: 1.44, cgpg: 1.22, homeGpg: 1.70, homeCgpg: 0.95, awayGpg: 1.18, awayCgpg: 1.49 }, // Japon
