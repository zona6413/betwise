...
const TEAM_META = {
  ...
  31:   { keyPlayer: { name: 'Hakim Ziyech',        role: 'Meneur technique' },   dangerMan: { name: 'Youssef En-Nesyri',  note: 'Finisseur aérien' },              style: 'Bloc bas, organisation défensive' },
  ...
  12:   { keyPlayer: { name: 'Wataru Endō',         role: 'Récupérateur' },       dangerMan: { name: 'Takumi Minamino',    note: 'Finisseur technique' },           style: 'Organisation rigoureuse, transitions rapides' },
  ...
  32:   { keyPlayer: { name: 'Mohamed Elneny',      role: 'Sentinelle' },          dangerMan: { name: 'Mohamed Salah',     note: 'Ailier de classe mondiale' },     style: 'Bloc bas, danger sur les transitions via Salah' },
...
const STATIC_SCORERS = {
  ...
  2384: { topScorer: { name: 'Christian Pulisic',     goals: 7,  pos: 'AT', matchesPlayed: 12 }, scorer2: { name: 'Ricardo Pepi',      goals: 6, pos: 'BU', matchesPlayed: 11 }, scorer3: { name: 'Josh Sargent',       goals: 4, pos: 'BU', matchesPlayed: 10 } },
  ...
  31:   { topScorer: { name: 'Youssef En-Nesyri',     goals: 7,  pos: 'BU', matchesPlayed: 12 }, scorer2: { name: 'Hakim Ziyech',      goals: 4, pos: 'AT', matchesPlayed: 11 }, scorer3: { name: 'Sofiane Boufal',     goals: 3, pos: 'AG', matchesPlayed: 10 } },
  ...
  3:    { topScorer: { name: 'Andrej Kramarić',       goals: 7,  pos: 'BU', matchesPlayed: 12 }, scorer2: { name: 'Ivan Perišić',      goals: 4, pos: 'AG', matchesPlayed: 11 }, scorer3: { name: 'Bruno Petković',     goals: 3, pos: 'BU', matchesPlayed: 10 } },
  ...
  12:   { topScorer: { name: 'Takumi Minamino',       goals: 6,  pos: 'AT', matchesPlayed: 12 }, scorer2: { name: 'Kaoru Mitoma',      goals: 5, pos: 'AG', matchesPlayed: 11 }, scorer3: { name: 'Ritsu Doan',         goals: 4, pos: 'AD', matchesPlayed: 12 } },
  8:    { topScorer: { name: 'Luis Díaz',             goals: 8,  pos: 'AG', matchesPlayed: 12 }, scorer2: { name: 'Falcao García',     goals: 4, pos: 'BU', matchesPlayed: 8  }, scorer3: { name: 'Jhon Durán',         goals: 5, pos: 'BU', matchesPlayed: 11 } },
  13:   { topScorer: { name: 'Nicolas Jackson',       goals: 6,  pos: 'BU', matchesPlayed: 12 }, scorer2: { name: 'Pape Matar Sarr',   goals: 3, pos: 'MO', matchesPlayed: 12 }, scorer3: { name: 'Habib Diallo',       goals: 3, pos: 'BU', matchesPlayed: 10 } },
  32:   { topScorer: { name: 'Mohamed Salah',         goals: 9,  pos: 'AD', matchesPlayed: 12 }, scorer2: { name: 'Mostafa Mohamed',  goals: 5, pos: 'BU', matchesPlayed: 11 }, scorer3: { name: 'Omar Marmoush',      goals: 4, pos: 'AT', matchesPlayed: 10 } },
  // ── Clubs — Premier League
